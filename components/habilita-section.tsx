...
export default function HabilitaSection() {
  ...
  useEffect(() => {
    const calculateTimeLeft = () => {
      ...
      // Calculate how many milliseconds have passed since the start of the current 7-day cycle
      const millisecondsIn7Days = 7 * 24 * 60 * 60 * 1000
      const cycleStart = Math.floor(currentTime / millisecondsIn7Days) * millisecondsIn7Days
      const nextCycleStart = cycleStart + millisecondsIn7Days

      const difference = nextCycleStart - currentTime
